...
class RawDataloader():
    ...
    def get_image_path_by_id(self, image_id):
        image_path = os.path.join(self.data_dir, self.data_type, 'jpg', str(image_id)+'.jpg')
        return image_path

    def get_segmentation_path_by_id(self, seg_id):
        seg_path = os.path.join(self.data_dir, self.data_type, 'mat', str(seg_id)+'_grass_gt.mat')
        return seg_path
    
    def get_homography_path_by_id(self, homo_id):
        homo_path = os.path.join(self.data_dir, self.data_type, 'homographyMatrix', str(homo_id)+'.homographyMatrix')
        return homo_path
